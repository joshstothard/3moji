...
Accepted by the owner on 2026-09-14 ([#244](https://github.com/joshstothard/3moji/issues/244)), then recorded the same day in [ADR-0011](adr/0011-canonical-word-aliases-name-one-handle-and-unclaimed-aliases-list-claimable-handles.md) (PR [#249](https://github.com/joshstothard/3moji/pull/249)), which partially supersedes [ADR-0008](adr/0008-handles-are-addressable-by-emoji-and-by-their-word-alias.md). No `/adr` run is left for you. Building it is [#248](https://github.com/joshstothard/3moji/issues/248):
