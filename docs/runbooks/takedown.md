...
- **No link on the page?** `REPORT_CONTACT_EMAIL` is unset or refused. It must be one plain address with nothing else in it — no display name, no second address, no spaces or line breaks (`apps/web/.env.example`). The mailbox is a dedicated forwarding alias, not a personal inbox (decided 2026-09-14). Creating the alias and pointing `REPORT_CONTACT_EMAIL` at it are owner actions (`docs/owner-actions.md`).
...
- **Commitment:** acknowledge every report within **48 hours** of it arriving, and act within **24 hours** on anything in the "act now" row of the triage table. The owner accepted these targets on 2026-09-14 ([#244](https://github.com/joshstothard/3moji/issues/244)). The `mailto:` link is how reports arrive at launch. No web form is needed before launch.
...
| ------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| **Act now.** Child sexual abuse material, terrorism content, a credible threat to somebody, or a live phishing or malware Link | Release the Handle (3b) within 24 hours of the report arriving, reserve it (3c), and report onward (below). Do not wait to hear from the owner. |
...
| Let users and affected people **easily report illegal content**                                                        | [s.20](https://www.legislation.gov.uk/ukpga/2023/50/section/20); the small-services page asks for "a complaints tool that allows users to report illegal or harmful material"                                       | **Partly, accepted for launch.** The report link and this runbook. A mailto needs a mail client. On 2026-09-14 the owner decided a mailto is enough for launch and a web form is not needed before launch ([#244](https://github.com/joshstothard/3moji/issues/244)). |
...
| **Take illegal content down swiftly** once aware of it                                                                 | Illegal content duties page, above                                                                                                                                                                                  | This runbook, steps 2 and 3. The commitment (§ 1): act within 24 hours on an "act now" report, and acknowledge every report within 48 hours.                                                                                                                          |
