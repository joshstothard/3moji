...
- 2026-09-14 — The owner accepted that the shareable word address should prefer a shorter name where it names only one Handle. ADR-0011 (above) records the narrower form the owner chose after seeing the measurements, and [#248](https://github.com/joshstothard/3moji/issues/248) builds it. Accepted by the owner (#244).
...
- 2026-09-14 — A word address that matches several Handles, none of them claimed, lists the ones that can be claimed (option 1 of [#121](https://github.com/joshstothard/3moji/issues/121)). ADR-0011 decision 5 records it, and #248 builds it. Accepted by the owner (#244).
