      ...
      {state === "manual" && (
        <div className="mt-4 text-left">
          ...
          <input
            ...
            className="mt-1 block w-full rounded-xl border border-slate-300 px-3 py-2 font-mono text-slate-900 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
          />
        </div>
      )}
      <p
